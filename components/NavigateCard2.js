...
import RideOptionsCard2 from './RideOptionsCard2'
  ...
  return (
    <SafeAreaView style={tw`bg-black flex-1`}>
          ...
          <GooglePlacesAutocomplete
            ...
            onPress={(data, details = null) => {
              ...
              dispatch(setDestination({
                ...
                navigation.navigate("RideOptionsCard2")
            }}
      ...
      <View style={tw`flex-row bg-black justify-evenly py-2 mt-auto border-t border-gray-100`}>
        <TouchableOpacity onPress={() => navigation.navigate("RideOptionsCard2")} style={tw`flex flex-row justify-between bg-white w-36 px-4 py-3 rounded-full`}>
